...
See `/ov-build:layer` for the full verb catalog. The validator enforces:
...
- `/ov-build:layer` — **Canonical reference** for the task verb catalog, `vars:` substitution, YAML anchors, execution order. The validator rules above enforce what's documented there.
