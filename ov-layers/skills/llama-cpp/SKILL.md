...
The user.yml runs after the pixi environment is established by the parent layer. The `gguf` Python package (for programmatic GGUF access) is declared in the parent layer's pixi.toml, not here.
