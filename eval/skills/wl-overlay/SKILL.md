...
- `/ov-eval:wl` — Compositor-agnostic desktop automation (screenshots, input, windows)
- `/ov-eval:record` — Terminal and desktop recording (overlays compose with recording workflow)
