...
Deploy-scope (uses `/ov-advanced:eval-k8s`):
...
- `/ov-foundation:k3s-server` — Control-plane node this agent joins
- `/ov-advanced:eval-k8s` — Test verb used by the agent-joined check
