...
See `/ov-advanced:enc` for full encrypted volume operations documentation.
...
- `/ov-foundation:virtualization` -- part of `ov-full` alongside gocryptfs
- `/ov-foundation:socat` -- part of `ov-full` alongside gocryptfs
