...
- `/ov-coder:dev-tools` — bat, ripgrep, neovim, gh, direnv, etc.
- `/ov-coder:build-toolchain` — gcc, cmake, autoconf, ninja, git
- `/ov-coder:nodejs` — Node.js + npm
...
## Related Images
- `/ov-foundation:fedora` — local-layer parent base image
- `/ov-foundation:fedora-builder` — local-layer alternative bundling the same tooling

## Related Commands
- `/ov-build:build` — fetch remote layer refs and build the image
- `/ov-build:validate` — validate remote layer references resolve
