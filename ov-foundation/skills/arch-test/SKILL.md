...
- `/ov-foundation:archlinux` — base image
- `/ov-foundation:archlinux-builder` — builder image (provides yay for AUR builds)
- `/ov-foundation:arch-pac-test` — pacman test layer
- `/ov-foundation:arch-aur-test` — AUR test layer
