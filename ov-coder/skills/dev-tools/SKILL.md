...
- `/ov-build:eval` — `exclude_distros:` field reference for the fastfetch-binary test
- `/ov-build:layer` — authoring reference for distro-tolerant `cmd:` tasks and `exclude_distros:`
