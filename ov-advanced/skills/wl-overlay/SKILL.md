...
- `/ov-advanced:wl` — Compositor-agnostic desktop automation (screenshots, input, windows)
- `/ov-advanced:record` — Terminal and desktop recording (overlays compose with recording workflow)
- `/ov-advanced:cdp` — Chrome DevTools Protocol (DOM-level interaction)
