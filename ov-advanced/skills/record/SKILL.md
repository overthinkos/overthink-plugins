...
> **Moved under `ov eval` in 2026-04** — the top-level `ov record` command was removed as a hard cutover. See `/ov-build:eval` for the live-container verb family (cdp/wl/dbus/vnc/mcp/spice/libvirt/record).
