...
- `/charly-build:charly-mcp-cmd` — client-side verb for probing this server's tool catalog (ping, list-tools, call); use `charly eval mcp list-tools jupyter` to see all 11 tools this candy registers
