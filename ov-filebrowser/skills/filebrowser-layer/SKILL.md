...
- `/ov-foundation:traefik` -- similar pattern (binary download + config file + supervisord)
- `/ov-foundation:dbus` -- D-Bus session bus (co-deployed in filebrowser image)
- `/ov-foundation:ov` -- ov CLI (co-deployed in filebrowser image)
