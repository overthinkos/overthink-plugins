...
- `/ov:enc` -- Encrypted volume mount lifecycle (inline mount in direct mode, `ExecStartPre=ov config mount` in quadlet mode, short-circuit fast path, iteration-capable ssClient credential lookup)
