...
- `/overthink-layers:jupyter` — Jupyter server + ML pixi environment
- `/overthink-layers:cuda` — GPU support (via nvidia base)

## Related Images

- `/overthink-images:nvidia` — parent (GPU without Jupyter)
- `/overthink-images:python-ml` — ML libraries without Jupyter server
