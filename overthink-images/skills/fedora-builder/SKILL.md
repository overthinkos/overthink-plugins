...
- `/overthink-layers:pixi` — Python package management foundation
- `/overthink-layers:nodejs` — Node.js runtime and npm
- `/overthink-layers:build-toolchain` — C/C++ compilation tools

## Related Images

- `/overthink-images:fedora` — parent base
