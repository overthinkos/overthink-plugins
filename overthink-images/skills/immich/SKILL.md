...
- `/overthink-layers:rpmfusion` — non-free codec support (via fedora-nonfree base)

## Related Images

- `/overthink-images:fedora-nonfree` — parent base
- `/overthink-images:immich-cuda` — adds CUDA ML for face recognition and smart search
