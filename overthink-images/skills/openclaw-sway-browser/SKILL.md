...
- `/overthink-layers:sway-desktop` — full desktop composition (pipewire, wayvnc, chrome-sway, terminal, file manager, waybar)

## Related Images

- `/overthink-images:openclaw` — headless (no desktop)
- `/overthink-images:openclaw-ollama-sway-browser` — adds local LLM with Ollama
