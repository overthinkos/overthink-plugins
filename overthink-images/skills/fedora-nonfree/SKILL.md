...
- `/overthink-layers:rpmfusion` — RPM Fusion repository configuration

## Derived Images

- `/overthink-images:immich` — photo management with codec support

## Related Images

- `/overthink-images:fedora` — parent base (without non-free repos)
