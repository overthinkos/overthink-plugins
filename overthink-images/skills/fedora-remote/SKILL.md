...
- `/overthink-layers:dev-tools` — bat, ripgrep, neovim, gh, direnv, etc.
- `/overthink-layers:build-toolchain` — gcc, cmake, autoconf, ninja, git
- `/overthink-layers:nodejs` — Node.js + npm
