...
- `/ov-marimo:versatiles-style` — sibling MapLibre style generator; the generated styles reference the glyph URL pattern this layer provides
- `/ov-marimo:versatiles-frontend` — re-exports this bundle at `/fonts/`
- `/ov-marimo:maplibre-versatiles-styler` — UI control that lets users switch between font families exposed by this layer
- `/ov-marimo:notebook-osm` — the shortbread MapLibre cell that patches `style.glyphs` to point at this layer's bundle
