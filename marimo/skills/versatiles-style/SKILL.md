...
- `/ov-marimo:versatiles` — the tile-server backend the generated
  styles point at after URL patching
- `/ov-marimo:versatiles-frontend` — re-exports this bundle at
  `/style/` for iframe consumption
- `/ov-marimo:shortbread` — the tile schema the styles render
