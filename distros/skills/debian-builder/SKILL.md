...
Build it from the submodule: `charly -C image/debian image build debian-builder`
...
```bash
charly -C image/debian image build debian-builder
...
- `charly -C image/debian image list | grep debian-builder` — image present.
