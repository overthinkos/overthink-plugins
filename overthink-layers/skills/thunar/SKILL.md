...
- `/overthink-layers:sway` -- Sway compositor dependency
- `/overthink-layers:sway-desktop` -- composition that includes this layer
- `/overthink-layers:xfce4-terminal` -- terminal emulator (also in sway-desktop)
