...
- `/overthink-images:immich`
- `/overthink-images:immich-cuda`

## Related Layers

- `/overthink-layers:supervisord` -- process manager dependency
- `/overthink-layers:nodejs24` -- Node.js runtime dependency
- `/overthink-layers:postgresql` -- database dependency
- `/overthink-layers:redis` -- cache dependency
- `/overthink-layers:immich-ml` -- optional ML backend
