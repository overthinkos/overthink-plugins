...
- `/overthink-images:fedora-builder`
- `/overthink-images:fedora-remote` (via remote layer ref)
- Transitive dependency for `openclaw`, `claude-code`, `pre-commit`, and other layers

## Related Layers

- `/overthink-layers:nodejs24` -- alternative Node.js 24 version
- `/overthink-layers:claude-code` -- depends on nodejs
- `/overthink-layers:pre-commit` -- depends on nodejs
