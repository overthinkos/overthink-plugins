...
- `/overthink-layers:socat` -- part of `ov-full` composition alongside virtualization
- `/overthink-layers:gocryptfs` -- part of `ov-full` composition alongside virtualization
