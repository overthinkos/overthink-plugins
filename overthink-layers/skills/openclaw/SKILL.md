...
- `/overthink-images:openclaw`
- `/overthink-images:openclaw-sway-browser`
- `/overthink-images:openclaw-ollama`
- `/overthink-images:openclaw-ollama-sway-browser`

## Related Layers

- `/overthink-layers:nodejs` -- Node.js runtime dependency
- `/overthink-layers:supervisord` -- process manager dependency
- `/overthink-layers:ollama` -- optional local LLM backend
