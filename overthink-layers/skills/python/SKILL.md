...
- `/overthink-layers:pixi` -- required dependency (provides pixi binary)
- `/overthink-layers:python-ml` -- ML-focused Python with CUDA support
- `/overthink-layers:language-runtimes` -- depends on python
