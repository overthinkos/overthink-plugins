...
- `/overthink-layers:chrome` -- depends on socat for DevTools port relay
- `/overthink-layers:virtualization` -- part of `ov-full` alongside socat
- `/overthink-layers:gocryptfs` -- part of `ov-full` alongside socat
