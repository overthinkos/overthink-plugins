...
- `/overthink-layers:chrome` -- Chrome browser and DevTools (included via layers)
- `/overthink-layers:sway-desktop` -- composition that includes chrome-sway
- `/overthink-layers:wayvnc` -- VNC access to see Chrome desktop
