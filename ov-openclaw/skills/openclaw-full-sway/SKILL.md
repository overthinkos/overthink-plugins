...
- `/ov-openclaw:openclaw-full` — All tool layers
- `/ov-selkies:sway-desktop-vnc` — Desktop with VNC access

## Related Images

- `/ov-openclaw:openclaw-sway-browser` — enabled variant (same concept, uses openclaw-full metalayer)
- `/ov-openclaw:openclaw-full` — headless variant (no desktop)
- `/ov-openclaw:openclaw-full-ml` — with ML/Ollama (disabled)
