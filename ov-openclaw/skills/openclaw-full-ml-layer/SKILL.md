...
- `/ov-foundation:whisper` -- speech-to-text component
- `/ov-foundation:sherpa-onnx` -- offline TTS component

## Related Commands
- `/ov-advanced:openclaw` -- gateway configuration and channel setup
