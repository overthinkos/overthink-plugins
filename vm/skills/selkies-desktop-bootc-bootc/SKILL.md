...
description: |
  ...
  MUST be invoked before editing selkies-desktop-bootc-bootc in image/bootc/overthink.yml.
---
...
- `/ov-infrastructure:keepassxc` — password manager (included in composition)
