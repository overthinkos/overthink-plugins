...
- `/ov-selkies:xorg-headless` -- X11 display server (dependency)
- `/ov-selkies:chrome-x11` -- Chrome on X11 (launched via openbox autostart)
- `/ov-selkies:x11-desktop` -- desktop composition
