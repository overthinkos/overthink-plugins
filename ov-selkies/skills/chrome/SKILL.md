...
- `/ov-foundation:supervisord` — required dependency for cdp-proxy service
...
- `/ov-advanced:cdp` — Chrome DevTools Protocol automation (click, type, eval, screenshot)
