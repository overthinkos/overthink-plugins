...
- `/ov-images:openclaw-sway-browser` — same but without Ollama (no GPU needed)
- `/ov-images:openclaw-ollama` — headless OpenClaw + Ollama (no desktop)
- `/ov-images:nvidia` — GPU base
