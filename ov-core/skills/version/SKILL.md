...
- `/ov-build:image` — build-mode family that stamps CalVer tags matching this version
- `/ov-build:eval` — declarative testing framework (Gotcha #5 covers the stdout rule)
