...
For container lifecycle, use `ov` commands -- see `/overthink:service`.
...
- `/overthink:alias` -- Host command aliases (`ov alias add openclaw`)
- `/overthink:shell` -- `ov shell --tty` for interactive container commands
